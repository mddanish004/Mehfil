...
const env = {
  ...
  DODO_PAYMENTS_DEFAULT_PRODUCT_ID: process.env.DODO_PAYMENTS_DEFAULT_PRODUCT_ID || null,
  DODO_PAYMENTS_TAX_CATEGORY: process.env.DODO_PAYMENTS_TAX_CATEGORY || 'digital_products',
  PAYMENT_CURRENCY: process.env.PAYMENT_CURRENCY || 'USD',
  PAYMENT_PLATFORM_FEE_PERCENT: Number(process.env.PAYMENT_PLATFORM_FEE_PERCENT || 0),
  PAYMENT_PROCESSING_FEE_PERCENT: Number(process.env.PAYMENT_PROCESSING_FEE_PERCENT || 0),
  PAYMENT_PROCESSING_FEE_FIXED: Number(process.env.PAYMENT_PROCESSING_FEE_FIXED || 0),
}
